...
<body onload="javascript:to_top()" 
	style="background-color:#009ACD;margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;">
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">商海互助公益管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
