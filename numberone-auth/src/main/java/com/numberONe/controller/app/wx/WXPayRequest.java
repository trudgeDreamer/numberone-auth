...
public class WXPayRequest {
    ...
    public String requestWithoutCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs,  boolean autoReport) throws Exception {
        //return this.requestOnce(urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, false, autoReport);
    	return this.requestOnce("http://www.gzshhuzhu.com/", urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, true);
        /*
        String result;
        Exception exception;
