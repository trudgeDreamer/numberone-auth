...
public class OrderJson {
	...
	private String order_amount;//捐赠金额
	private String descript;//捐赠描述
	private String phone;//联系方式
	private String prepay_id;//预支付id
	private String update_time;//更新时间
	private String order_status;//订单状态
	private String donate_theme;//捐赠主题
	...
	public String getDonate_theme() {
		return donate_theme;
	}
	public void setDonate_theme(String donate_theme) {
		this.donate_theme = donate_theme;
	}
	...
	public String toString() {
		return "OrderJson [order_id=" + order_id + ", order_time=" + order_time + ", order_amount=" + order_amount
				+ ", descript=" + descript + ", phone=" + phone + ", prepay_id=" + prepay_id + ", update_time="
				+ update_time + ", order_status=" + order_status + ", donate_theme=" + donate_theme + "]";
	}
