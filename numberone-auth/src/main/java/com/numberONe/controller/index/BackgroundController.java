...
import com.numberONe.controller.config.ModelAndConfig;
...
public class BackgroundController extends BaseController {
	...
	public String index(Model model) throws Exception {
		...
		for(TreeObject to:ns){
			System.out.println(to.getName()+to.getChildren().size());
		}
		model.addAttribute("list", ns);
		// 登陆的信息回传页面
		model.addAttribute("userFormMap", userFormMap);
		ModelAndConfig.setModelConfig(model);
		return "/index";
	}
